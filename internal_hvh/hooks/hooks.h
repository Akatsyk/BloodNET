...
namespace hooks
{
	...
	extern is_paused_fn orig_is_paused;
	...
	using WriteUserCmdDeltaToBuffer_t = bool(__fastcall*)(int, void*, int, int, bool);
	extern WriteUserCmdDeltaToBuffer_t orig_WriteUserCmdDeltaToBuffer;
	bool __fastcall WriteUserCmdDeltaToBuffer(int, void*, int, int, bool);
