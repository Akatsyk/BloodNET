...
public:
	VFUNC( 17, get_pred_desc_map(), datamap_t*( __thiscall * )( void* ) )( )
		...
		NETVAR( get_network_ang, QAngle, "CBaseEntity->m_angNetworkAngles" )
		NETVAR(get_velocity_modifier, float, "CBaseEntity->m_flVelocityModifier")
		OFFSET( get_take_damage, int, 0x27C)
		OFFSET(get_view_offset, Vector, 0x104) // Doenst work
...
public:
	...
	{
		static auto fnGetStaticData = reinterpret_cast< CEconItemDefinition*( __thiscall* )( void* ) >( sig( "client.dll", "55 8B EC 51 56 57 8B F1 E8 ? ? ? ? 0F B7 8E" ) ); //client.dll
...
public:
	NETVAR( get_next_primary_attack, float, "CBaseCombatWeapon->m_flNextPrimaryAttack" )
		...
		DATAMAPVAR(get_activity, int, "m_Activity")
		...
		VFUNC(439, get_spread(), float(__thiscall*)(void*))()
		VFUNC(469, get_inaccuracy(), float(__thiscall*)(void*))()
		VFUNC(470, update_accuracy(), void(__thiscall*)(void*))()
		VFUNC(446, get_wpn_data(), CCSWeaponData* (__thiscall*)(void*))()
...
public:
	NETVAR( get_lifestate, LifeState, "CBasePlayer->m_lifeState" )
		...
		NETVAR( get_surface_friction, float, "CBasePlayer->m_surfaceFriction" )
		...
		NETVAR(get_aim_punch_vel, QAngle, "CBasePlayer->m_aimPunchAngleVel")
		...
		NETVAR( get_ground_entity, CBaseHandle, "CBasePlayer->m_hGroundEntity")
	...
	void draw_hitboxes(lag_record_t& record, matrix3x4_t* matrix, Color col, float time) const;
};
...
public:
		...
		NETVAR( get_health_shot_boost_expiration_time, float, "CCSPlayer->m_flHealthShotBoostExpirationTime") // m_flHealthShotBoostExpirationTime
