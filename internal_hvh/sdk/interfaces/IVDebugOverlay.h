...
public:
	...
	VFUNC( 24, AddCapsuleOverlay( Vector& mins, Vector& maxs, float radius, int r, int g, int b, int a, float duration ), void( __thiscall* )( void*, Vector&, Vector&, float&, int, int, int, int, float ) )( mins, maxs, radius, r, g, b, a, duration )
		VFUNC( 25, AddCapsuleOverlayVisible( Vector& mins, Vector& maxs, float radius, int r, int g, int b, int a, float duration ), void( __thiscall* )( void*, Vector&, Vector&, float&, int, int, int, int, float ) )( mins, maxs, radius, r, g, b, a, duration )
};
