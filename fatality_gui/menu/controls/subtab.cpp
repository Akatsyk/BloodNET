...
void c_subtab::render(bool selected)
{
	...
	render::get().text(Vector2D(parent_window->m_subtabarea.x + 20, parent_window->m_subtabarea.y + 12), parent_name, D3DCOLOR_RGBA(240, 240, 240, 250), fonts::subtabfont, c_font::left_aligned);
	...
	if (selected)
	{
		render::get().line(Vector2D(parent_window->m_subtabarea.x + 20, parent_window->m_subtabarea.y + 42 + 28 * m_id + 8 * m_id),
			Vector2D(parent_window->m_subtabarea.x + 20,
				parent_window->m_subtabarea.y + 42 + 28 * m_id + 8 * m_id + 28), D3DCOLOR_RGBA(235, 5, 90, 250));
		...
		render::get().text(Vector2D(parent_window->m_subtabarea.x + 28, parent_window->m_subtabarea.y + 42 + 28 * m_id + 8 * m_id + 14 - (render::get().get_text_size(name, fonts::subtabfont).y / 2)),
			name, Color(235, 5, 90, 250), fonts::subtabfont, c_font::left_aligned);
	...
	{
		render::get().text(Vector2D(parent_window->m_subtabarea.x + 28, parent_window->m_subtabarea.y + 42 + 28 * m_id + 8 * m_id + 14 - (render::get().get_text_size(name, fonts::subtabfont).y / 2)),
			name, hovered ? D3DCOLOR_RGBA(219, 218, 225, 250) : D3DCOLOR_RGBA(130, 130, 140, 250), fonts::subtabfont, c_font::left_aligned);
	}
}
