...
std::vector< std::string > m_fake_angles =
{
	_w( "Spin" ),
	_w( "Back jitter" ),
	_w( "Forward" ),
...
std::vector<std::string> hitscan_when =
{
	_w("Head"),
	_w("Neck"),
	_w("Chest"),
...
std::vector<std::string> hitscan_when_au =
{
	_w("aim_au_hs_1"), // HEAD
	_w("aim_au_hs_2"), // NECK
	_w("aim_au_hs_3"), // CHEST
	_w("aim_au_hs_4"), // FOREARMS
	_w("aim_au_hs_5"), // BODY
	_w("aim_au_hs_6"), // CALFS
	_w("aim_au_hs_7"), // FOOTS
};

std::vector<std::string> hitscan_when_sc =
{
	_w("aim_sc_hs_1"), // HEAD
	_w("aim_sc_hs_2"), // NECK
	_w("aim_sc_hs_3"), // CHEST
	_w("aim_sc_hs_4"), // FOREARMS
	_w("aim_sc_hs_5"), // BODY
	_w("aim_sc_hs_6"), // CALFS
	_w("aim_sc_hs_7"), // FOOTS
};

std::vector<std::string> hitscan_when_awp =
{
	_w("aim_awp_hs_1"), // HEAD
	_w("aim_awp_hs_2"), // NECK
	_w("aim_awp_hs_3"), // CHEST
	_w("aim_awp_hs_4"), // FOREARMS
	_w("aim_awp_hs_5"), // BODY
	_w("aim_awp_hs_6"), // CALFS
	_w("aim_awp_hs_7"), // FOOTS
};

std::vector<std::string> hitscan_when_hp =
{
	_w("aim_hp_hs_1"), // HEAD
	_w("aim_hp_hs_2"), // NECK
	_w("aim_hp_hs_3"), // CHEST
	_w("aim_hp_hs_4"), // FOREARMS
	_w("aim_hp_hs_5"), // BODY
	_w("aim_hp_hs_6"), // CALFS
	_w("aim_hp_hs_7"), // FOOTS
};

std::vector<std::string> hitscan_when_p =
{
	_w("aim_p_hs_1"), // HEAD
	_w("aim_p_hs_2"), // NECK
	_w("aim_p_hs_3"), // CHEST
	_w("aim_p_hs_4"), // FOREARMS
	_w("aim_p_hs_5"), // BODY
	_w("aim_p_hs_6"), // CALFS
	_w("aim_p_hs_7"), // FOOTS
};

std::vector<std::string> hitscan_when_o =
{
	_w("aim_o_hs_1"), // HEAD
	_w("aim_o_hs_2"), // NECK
	_w("aim_o_hs_3"), // CHEST
	_w("aim_o_hs_4"), // FOREARMS
	_w("aim_o_hs_5"), // BODY
	_w("aim_o_hs_6"), // CALFS
	_w("aim_o_hs_7"), // FOOTS
};

//std::vector<std::string> override_hitscan_when_au =
//{
//	_w("aim_au_override_hs_1"),
//	_w("aim_au_override_hs_2"),
//	_w("aim_au_override_hs_3"),
//	_w("aim_au_override_hs_4"),
//	_w("aim_au_override_hs_5"),
//	_w("aim_au_override_hs_6"),
//	_w("aim_au_override_hs_7"),
//	_w("aim_au_override_hs_8"),
//	_w("aim_au_override_hs_9"),
//	_w("aim_au_override_hs_10"),
//	_w("aim_au_override_hs_11"),
//	_w("aim_au_override_hs_12"),
//	_w("aim_au_override_hs_13")
//};
//
//std::vector<std::string> override_hitscan_when_sc =
//{
//	_w("aim_sc_override_hs_1"),
//	_w("aim_sc_override_hs_2"),
//	_w("aim_sc_override_hs_3"),
//	_w("aim_sc_override_hs_4"),
//	_w("aim_sc_override_hs_5"),
//	_w("aim_sc_override_hs_6"),
//	_w("aim_sc_override_hs_7"),
//	_w("aim_sc_override_hs_8"),
//	_w("aim_sc_override_hs_9"),
//	_w("aim_sc_override_hs_10"),
//	_w("aim_sc_override_hs_11"),
//	_w("aim_sc_override_hs_12"),
//	_w("aim_sc_override_hs_13")
//};
//
//std::vector<std::string> override_hitscan_when_awp =
//{
//	_w("aim_awp_override_hs_1"),
//	_w("aim_awp_override_hs_2"),
//	_w("aim_awp_override_hs_3"),
//	_w("aim_awp_override_hs_4"),
//	_w("aim_awp_override_hs_5"),
//	_w("aim_awp_override_hs_6"),
//	_w("aim_awp_override_hs_7"),
//	_w("aim_awp_override_hs_8"),
//	_w("aim_awp_override_hs_9"),
//	_w("aim_awp_override_hs_10"),
//	_w("aim_awp_override_hs_11"),
//	_w("aim_awp_override_hs_12"),
//	_w("aim_awp_override_hs_13")
//};
//
//std::vector<std::string> override_hitscan_when_hp =
//{
//	_w("aim_hp_override_hs_1"),
//	_w("aim_hp_override_hs_2"),
//	_w("aim_hp_override_hs_3"),
//	_w("aim_hp_override_hs_4"),
//	_w("aim_hp_override_hs_5"),
//	_w("aim_hp_override_hs_6"),
//	_w("aim_hp_override_hs_7"),
//	_w("aim_hp_override_hs_8"),
//	_w("aim_hp_override_hs_9"),
//	_w("aim_hp_override_hs_10"),
//	_w("aim_hp_override_hs_11"),
//	_w("aim_hp_override_hs_12"),
//	_w("aim_hp_override_hs_13")
//};
//
//std::vector<std::string> override_hitscan_when_p =
//{
//	_w("aim_p_override_hs_1"),
//	_w("aim_p_override_hs_2"),
//	_w("aim_p_override_hs_3"),
//	_w("aim_p_override_hs_4"),
//	_w("aim_p_override_hs_5"),
//	_w("aim_p_override_hs_6"),
//	_w("aim_p_override_hs_7"),
//	_w("aim_p_override_hs_8"),
//	_w("aim_p_override_hs_9"),
//	_w("aim_p_override_hs_10"),
//	_w("aim_p_override_hs_11"),
//	_w("aim_p_override_hs_12"),
//	_w("aim_p_override_hs_13")
//};
//
//std::vector<std::string> override_hitscan_when_o =
//{
//	_w("aim_o_override_hs_1"),
//	_w("aim_o_override_hs_2"),
//	_w("aim_o_override_hs_3"),
//	_w("aim_o_override_hs_4"),
//	_w("aim_o_override_hs_5"),
//	_w("aim_o_override_hs_6"),
//	_w("aim_o_override_hs_7"),
//	_w("aim_o_override_hs_8"),
//	_w("aim_o_override_hs_9"),
//	_w("aim_o_override_hs_10"),
//	_w("aim_o_override_hs_11"),
//	_w("aim_o_override_hs_12"),
//	_w("aim_o_override_hs_13")
//};
...
void save_config()
{
	...
	g_pSurface->PlaySound("ui/buttonclick.wav");
}
...
void c_menu::init()
{
	...
	c_tab* tab_first = main_window->add_tab( _w( "Rage" ) );
	{
		c_subtab* subtab_one = tab_first->add_subtab( _w( "Aimbot" ) );
		{
			...
			subtab_one->add_checkbox( _w( "Extended backtrack" ), _w( "aim_ps_bs" ) );
			subtab_one->add_checkbox( _w( "Fake latency" ), _w( "aim_ps" ) );
			subtab_one->add_keybind( _w( "" ), _w( "k_ps" ), true );
			subtab_one->add_slider( _w( "Fake latency amount" ), _w( "aim_ps_at" ), 0, 800, _w( "%d ms" ) );
			subtab_one->add_checkbox( _w( "HS only" ), _w( "aim_hsonly" ) );
			subtab_one->add_checkbox( _w( "Backtrack" ), _w( "aim_bt" ) );
			subtab_one->add_checkbox( _w( "AntiAim correction" ), _w( "aim_rslv" ) );
		...
		c_subtab* subtab_three = tab_first->add_subtab( _w( "Anti-aim" ) );
		{
			...
			subtab_three->add_checkbox(_w("Fakemove"), _w("aa_fkdk"));
			subtab_three->add_keybind(_w(""), _w("k_fkdk"), true);
			subtab_three->add_slider(_w("Fakemove amount"), _w("aa_fkmv_t"), 0, 14, _w("%d ticks"));
			...
			subtab_three->add_checkbox( _w( "FPS optimization" ), _w( "aa_fs_fps" ) );
		...
		c_subtab* subtab_four = tab_first->add_subtab( _w( "AA Regular" ) );
		{
			...
			//subtab_four->add_checkbox( _w( "Autodirection lby" ), _w( "aa_r_lby_autodirection" ) ); // note - AkatsukiSun: doesnt work
	...
	c_tab* tab_second = main_window->add_tab( _w( "Config" ) );
	{
		...
		c_subtab* subtab_two = tab_second->add_subtab( _w( "Auto" ) );
		{
			...
			//subtab_two->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_au);
			//subtab_two->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_au);
		...
		c_subtab* subtab_three = tab_second->add_subtab( _w( "Scout" ) );
		{
			...
			//subtab_three->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_sc);
			//subtab_three->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_sc);
			//subtab_three->add_keybind(_w(""), _w("k_override_hs"), true);
		...
		c_subtab* subtab_four = tab_second->add_subtab( _w( "AWP" ) );
		{
			...
			//subtab_four->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_awp);
			//subtab_four->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_awp);
		...
		c_subtab* subtab_five = tab_second->add_subtab( _w( "Heavy pistols" ) );
		{
			...
			//subtab_five->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_hp);
			//subtab_five->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_hp);
		...
		c_subtab* subtab_six = tab_second->add_subtab( _w( "Pistols" ) );
		{
			...
			//subtab_six->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_p);
			//subtab_six->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_p);
		...
		c_subtab* subtab_seven = tab_second->add_subtab( _w( "Other" ) );
		{
			...
			//subtab_seven->add_multi(_w("Hitscan"), &hitscan_when, &hitscan_when_o);
			//subtab_seven->add_multi(_w("Override"), &hitscan_when, &override_hitscan_when_o);
			//subtab_seven->add_keybind(_w(""), _w("k_override_hs"), true);
	...
	c_tab* tab_third = main_window->add_tab( _w( "Visuals" ) );
	{
		...
		c_subtab* subtab_two = tab_third->add_subtab( _w( "Esp" ) );
		{
			...
			subtab_two->add_checkbox(_w("Dormant esp"), _w("v_drmnt_esp"));
	...
	c_tab* tab_fourth = main_window->add_tab( _w( "Gameplay" ) );
	{
		...
		c_subtab* subtab_two = tab_fourth->add_subtab( _w( "Movement" ) );
		{
			...
			subtab_two->add_checkbox(_w("Aspect Ratio"), _w("aspect"));
			subtab_two->add_slider(_w("Aspect Ratio Size"), _w("aspectsize"), 0, 20, _w("%d"));
			subtab_two->add_checkbox(_w("Grenade Trajectory"), _w("m_gren_traj"));
			subtab_two->add_checkbox(_w("Peek Assistance"), _w("m_autopeek"));
			subtab_two->add_keybind(_w(""), _w("k_autopeek"), true);
			subtab_two->add_slider(_w("Peek Assistance Radius"), _w("m_autopeek_radius"), 0.f, 50.f, _w("%.1f pt"));
...
void c_menu::draw_cursor()
{
	...
	D3DCOLOR main_color = D3DCOLOR_RGBA( 255, 10, 10, 255 );
	D3DCOLOR back_color = D3DCOLOR_RGBA( 255, 255, 255, 255 );
